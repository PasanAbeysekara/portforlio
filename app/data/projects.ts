...
export const yourYouTubeUrl = 'https://youtube.com/@yourChannel'; // Update with your YouTube channel
export const yourInstagramUrl = 'https://instagram.com/yourhandle'; // Update with your Instagram
export const yourStackOverflowUrl = 'https://stackoverflow.com/users/yourid'; // Update with your StackOverflow