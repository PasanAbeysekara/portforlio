    ...
    <div>
      ...
      <div className="pb-4 mb-4 border-b border-gh-border">
        ...
        <div className="flex items-center gap-2 mt-4">
            <Link href={project.demoUrl} target="_blank" className="flex items-center gap-1 bg-gh-button hover:bg-gh-button-hover border border-gh-border rounded-md px-3 py-1 text-sm transition-colors">
                <Star size={16} /> Live Demo
            </Link>
             <Link href={project.repoUrl} target="_blank" className="flex items-center gap-1 bg-gh-button hover:bg-gh-button-hover border border-gh-border rounded-md px-3 py-1 text-sm transition-colors">
