    ...
    <div className="my-64">
      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            type="Bachelor of Science in Computer Engineering (Hons.)"
            time="2021-2025"
            place="University of Ruhuna (UOR)"
          ...
          <Details
              ...
              info="Completed coursework in topics such as Machine Learning , Computer Vision, and Deep Learning."
          />
