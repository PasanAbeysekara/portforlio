...
import {
    DribbbleIcon,
    GithubIcon, HackerrankIcon, KaggleIcon,
    LinkedInIcon,
    MoonIcon,
    PinterestIcon, StackOverflowIcon,
    SunIcon,
    TwitterIcon,
} from "./Icons";
      ...
      "
          >
              <motion.a
                  target={"_blank"}
                  className="w-6 mx-3"
                  href="https://github.com/PasanAbeysekara"
                  whileHover={{y: -2}}
                  whileTap={{scale: 0.9}}
              ...
              <motion.a
                  target={"_blank"}
                  className="w-6 mx-3"
                  href="https://www.linkedin.com/in/pasan-kavinda-abeysekara/"
                  whileHover={{y: -2}}
                  whileTap={{scale: 0.9}}
              ...
              <motion.a
                  ...
                  href="https://www.hackerrank.com/profile/EG_2020_3799"
                  whileHover={{y: -2}}
                  whileTap={{scale: 0.9}}
              ...
              <motion.a
                  target={"_blank"}
                  className="w-6 mr-3"
                  href="https://stackoverflow.com/users/13503639/pasan"
                  whileHover={{y: -2}}
                  whileTap={{scale: 0.9}}
              ...
              <motion.a
                  target={"_blank"}
                  className="w-6 mx-3"
                  href="https://www.kaggle.com/pasankavinda"
                  whileHover={{y: -2}}
                  whileTap={{scale: 0.9}}
